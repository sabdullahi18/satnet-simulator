...
# 2. Setup the figure with 2 subplots
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(15, 6))

# --- PLOT 1: SORTED LATENCY CURVE ---
# Sort the packets by their actual delay to see the distribution curve
...
# Plot the MinDelay (Physical Limit) for context
...
# Highlight the "Tail" (The Natural Spikes)
# The highest 10% of delays are likely the "Spikes" you saw in logs
